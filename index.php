               ...
               <div class="carousel-item active">
                  <div class="container">
                     <div class="banner_taital_main">
                        <div class="row">
                           <div class="col-md-6">
                              <h1 class="banner_taital">E-Learning System</h1>
                              <p class="banner_text">Stop thinking the answer to everything is to develop a course</p>
                              <div class="btn_main">
            ...
            <div class="footer_section_2">
               <div class="row">
                  <div class="col-lg-3 margin_top">
                     <div class="call_text"><a href="#"><img src="images/call-icon1.png"><span class="padding_left_15">Call Now +92 30076543210</span></a></div>
                  ...
                  <div class="col-lg-3">
                     <div class="information_main">
                        ...
                        <p class="many_text">When it comes to eLearning, content means everything</p>
                     </div>
                  </div>
